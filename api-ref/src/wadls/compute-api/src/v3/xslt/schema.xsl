...
<!-- (C) 2014 Rackspace Hosting, All Rights Reserved -->
<xslt:stylesheet version="1.0"
  ...
  <xslt:output method="html" encoding="UTF-8" media-type="text/html"
  ...
  <!-- Global Variables -->
  <xslt:variable name="defaultTitle">XML Schema
    Documentation</xslt:variable>
  <xslt:variable name="templateType"
    >application/xhtml+xml</xslt:variable>
  <xslt:variable name="schemaNamespace"
    >http://www.w3.org/2001/XMLSchema</xslt:variable>
  <xslt:variable name="schemaDatatypeURI"
    >http://web4.w3.org/TR/2001/REC-xmlschema-2-20010502/#</xslt:variable>
  ...
  -->
  <xslt:variable name="YUI_BASE"
    >http://yui.yahooapis.com/2.7.0/build/</xslt:variable>
  ...
  <xslt:template name="SchemaHandler" match="xsd:schema">
    <html>
      <head>
        ...
        <xslt:call-template name="addStylesheet">
          <xslt:with-param name="sheet"
            select="concat($base,'/style/schema.css')"/>
        </xslt:call-template>
        <!--
            Add custom links...
        -->
        ...
        <xslt:choose>
          <xslt:when test="xsd:annotation/xsd:appinfo/xsdxt:title">
            <title>
              <xslt:value-of
                select="xsd:annotation/xsd:appinfo/xsdxt:title"/>
            </title>
          </xslt:when>
          <xslt:otherwise>
            <title>
        ...
        <div id="doc">
          <div id="Main">
            ...
            <div id="Content">
              ...
              <xslt:choose>
                <xslt:when
                  test="xsd:annotation/xsd:appinfo/xsdxt:title">
                  <h1>
                    <xslt:value-of
                      select="xsd:annotation/xsd:appinfo/xsdxt:title"
                    />
              ...
              <xslt:apply-templates
                select="xsd:annotation/xsd:documentation/*"
                mode="Docs"/>
              <!--
              ...
              <xslt:choose>
                <xslt:when test="count(namespace::*) = 0">
                  ...
                  <div class="Warning">
                    <p> Your browser does not seem to have support for
                      namespace nodes in XPath. If you're a Firefox
                      user, please consider voting to get this issue
                      resolved: <a
                        href="https://bugzilla.mozilla.org/show_bug.cgi?id=94270"
      ...
      <xslt:call-template name="ControllerJSLink">
        ...
        <xslt:with-param name="title">
          <xslt:choose>
            <xslt:when test="@namespace">
              <xslt:value-of
                select="concat('View schema for namespace ',@namespace)"
              />
            </xslt:when>
            <xslt:otherwise>
              <xslt:value-of
                select="concat('Visit schema ',@schemaLocation)"/>
            </xslt:otherwise>
          </xslt:choose>
        </xslt:with-param>
      </xslt:call-template>
      <xslt:if
        test="$nodes[count($nodes)]/@schemaLocation !=
                     @schemaLocation">
        <xslt:text>,</xslt:text>
      </xslt:if>
    </xslt:for-each>
  ...
  <xslt:template name="ControllerNamedElementJSLink">
    ...
    <xslt:for-each select="$nodes">
      ...
      <xslt:if
        test="generate-id($nodes[count($nodes)]) !=
                     generate-id(.)">
        <xslt:text>,</xslt:text>
      </xslt:if>
    </xslt:for-each>
              ...
              <div class="Extern">
                <div class="ExternHref">
                  <xslt:element name="a">
                    ...
                    <xslt:attribute name="title">Visit <xslt:value-of
                        select="@schemaLocation"/></xslt:attribute>
                    <xslt:value-of select="@schemaLocation"/>
                  </xslt:element>
                </div>
                <div class="ExternDoc">
  ...
  <xslt:template name="ElementHandler">
    ...
    <xslt:for-each select="xsd:element">
      ...
      <xslt:if test="xsd:annotation/xsd:appinfo/xsdxt:samples">
        <xslt:apply-templates
          select="xsd:annotation/xsd:appinfo/xsdxt:samples"
          mode="Docs"/>
      </xslt:if>
    </xslt:for-each>
  </xslt:template>
  <xslt:template name="SampleHandler" match="xsdxt:samples"
    mode="Docs">
    ...
    <xslt:for-each select="xsdxt:sample">
      <xslt:element name="div">
        ...
        <div class="SampleDesc">
          <xslt:apply-templates select="xsdxt:description/*"
            mode="Docs"/>
        </div>
        ...
        <xslt:if test=".//xsd:extension">
          <div class="NameAddl">
            ...
            <xslt:for-each select=".//xsd:extension">
              ...
              <xslt:if
                test=".//xsd:extension[count(.//xsd:extension)]/@base != @base">
                <xslt:text>,</xslt:text>
              </xslt:if>
            </xslt:for-each>
          </div>
        ...
        <xslt:if test=".//xsd:restriction">
          <div class="NameAddl">
            ...
            <xslt:for-each select=".//xsd:restriction">
              <xslt:apply-templates select="@base" mode="QNameToLink"/>
              <xslt:if
                test=".//xsd:restriction[count(.//xsd:restriction)]/@base != @base">
                <xslt:text>,</xslt:text>
              </xslt:if>
            </xslt:for-each>
          </div>
  ...
  <xslt:template name="Attribs">
    ...
    <xslt:if
      test="(count(@*) > 1) or ((count(@*) = 1) and not(@name))">
      <xslt:element name="div">
  ...
  <xslt:template name="Docs">
    ...
    <xslt:if test="xsd:annotation/xsd:documentation">
      <xslt:element name="div">
        ...
        <xslt:apply-templates
          select="xsd:annotation/xsd:documentation/*" mode="Docs"/>
      </xslt:element>
    </xslt:if>
  </xslt:template>
  ...
  <xslt:template name="QNameToLink" match="@*" mode="QNameToLink">
    ...
    <xslt:choose>
      <xslt:when test="contains($qname,':')">
        <xslt:variable name="prefix"
          select="substring-before($qname,':')"/>
        <xslt:variable name="localName"
          select="substring-after($qname,':')"/>
        <xslt:choose>
          <xslt:when
            test="//xsdxt:link[(@qname = $qname) and (@rel = 'schema')]">
            <xslt:call-template name="Anchor">
              <xslt:with-param name="href"
                select="//xsdxt:link[(@qname = $qname) and (@rel = 'schema')]/@href"/>
              <xslt:with-param name="title"
                select="concat('See ',$localName)"/>
            </xslt:call-template>
          </xslt:when>
  ...
  <xslt:template name="QNameToXSDAnchor">
    ...
    <xslt:if test="namespace-uri(..) = $schemaNamespace">
      <xslt:if
        test="(local-name(.) = 'type') or (local-name(.) = 'base')">
    ...
    <xslt:choose>
      ...
      <xslt:when test="local-name(..) = 'element'">
        <xslt:call-template name="LocalRefAnchorBuilder">
          <xslt:with-param name="localName" select="$localName"/>
          <xslt:with-param name="search"
            select="/xsd:schema/xsd:element[@name= $localName]"/>
      ...
      <xslt:when test="local-name(..) = 'attribute'">
        <xslt:call-template name="LocalRefAnchorBuilder">
          <xslt:with-param name="localName" select="$localName"/>
          <xslt:with-param name="search"
            select="/xsd:schema/xsd:attribute[@name= $localName]"/>
      ...
      <xslt:when test="local-name(..) = 'attributeGroup'">
        <xslt:call-template name="LocalRefAnchorBuilder">
          <xslt:with-param name="localName" select="$localName"/>
          <xslt:with-param name="search"
            select="/xsd:schema/xsd:attributeGroup[@name= $localName]"/>
          <xslt:with-param name="refPrefix"
            select="$attributeGroupPrefix"/>
        </xslt:call-template>
      </xslt:when>
      <!-- Group Reference -->
      <xslt:when test="local-name(..) = 'group'">
        <xslt:call-template name="LocalRefAnchorBuilder">
          <xslt:with-param name="localName" select="$localName"/>
          <xslt:with-param name="search"
            select="/xsd:schema/xsd:group[@name= $localName]"/>
    ...
    <xslt:call-template name="SubItem">
      <xslt:with-param name="name">
        <xslt:choose>
          ...
          <xslt:when test="@ref">
            <xslt:variable name="elementName"
  ...
  <xslt:template match="xsd:restriction">
    ...
    <table summary="Restriction Props and Attributes">
      <tbody>
        ...
        <!-- simple restrictions -->
        <xslt:for-each
          select="xsd:minExclusive | xsd:minInclusive   |
    ...
    -->
    <xslt:apply-templates
      select="xsd:simpleType     | xsd:group     |
                                  xsd:all            | xsd:choice    |
    ...
    <td>
      <div class="Enum">
        ...
        <xslt:if test="$enum/xsd:annotation/xsd:documentation">
          <div class="EnumDoc">
            <xslt:apply-templates
              select="$enum/xsd:annotation/xsd:documentation/*"
              mode="Docs"/>
          </div>
        </xslt:if>
      </div>
  ...
  <xslt:template name="DisplaySimpleRestriction">
    ...
    <xslt:if test="$restriction/xsd:annotation/xsd:documentation">
      <td>
        <xslt:apply-templates
          select="$restriction/xsd:annotation/xsd:documentation/*"
          mode="Docs"/>
      </td>
    </xslt:if>
  </xslt:template>
  ...
  <xslt:template name="StringToName">
    ...
    <xslt:choose>
      ...
      <xslt:when
        test="(local-name($inNode) = 'element') and
      ...
      <xslt:when
        test="(local-name($inNode) = 'attribute') and
                       (namespace-uri($inNode) = $schemaNamespace)
                       ">
        <xslt:call-template name="StringToAttributeName">
          <xslt:with-param name="inString" select="$inString"/>
  ...
  <xslt:template name="StringToJavascript">
    ...
    <xslt:variable name="crString"
      select="translate($tabString,'&#x0d;','')"/>
  ...
  <xslt:template name="ReplaceText">
    ...
    <xslt:choose>
      <xslt:when
        test="$searchString and
                       contains($inString, $searchString)">
        <xslt:value-of
          select="substring-before($inString, $searchString)"/>
        <xslt:value-of select="$replaceString"/>
        <xslt:call-template name="ReplaceText">
          <xslt:with-param name="inString"
            select="substring-after($inString, $searchString)"/>
          <xslt:with-param name="searchString" select="$searchString"/>
          <xslt:with-param name="replaceString"
